# coding:utf-8
__author__ = 'BLUE'
__time__ = 'Sun Oct 28 2018 22:17:34 GMT+0800'
...
from Wechat.Exceptions import ParseError
from .Base import BaseCrypto
from .Utils import get_sha1_signature
from .Exceptions import ValidateSignatureError, ValidateAESKeyError, DecryptAESError
...
class WechatBaseCrypto(object):
    ...
    def _check_signature(self, msg_signature, timestamp, nonce, echostr):
        ...
        if not msg_signature == signature:
